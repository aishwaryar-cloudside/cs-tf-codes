module "cloudnat" {
    ...
    region = var.region
    natgw_name = "nat-c91-transit-apps-ass1-01"
    router_name = "cr-c91-transit-apps-ass1-01"
    nat_ips = [ "ip-c91-transit-nat-ass1-01" ]
