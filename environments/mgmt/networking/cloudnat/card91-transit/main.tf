module "cloudnat" {
    ...
    region = var.region
    natgw_name = "nat-card91-transit-apps-ass1-01"
    router_name = "cr-card91-transit-apps-ass1-01"
    nat_ips = [ "ip-card91-transit-nat-ass1-01" ]
