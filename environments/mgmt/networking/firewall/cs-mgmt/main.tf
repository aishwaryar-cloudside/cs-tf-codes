module "firewall_policy" {
  ...
  {
    name                    = "fw-mgmt-http-public"
    description             = "HTTP access to public for ${var.env}"
    direction               = "INGRESS"
    disabled                = false
    priority                = "102"
    source_ranges           = ["0.0.0.0/0", "10.24.16.0/20", "10.24.31.204/32", "10.24.31.214/32", "100.64.128.0/20", "142.251.175.132", "34.124.228.25/32"]
    source_tags             = null
    source_service_accounts = null
    target_tags             = null
    target_service_accounts = null
