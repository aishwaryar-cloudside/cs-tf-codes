module "firewall_policy" {
  ...
  {
    name                    = "fw-qa-shared-health-check-gcp"
  ...
  {
    name                    = "fw-gke-ingress-01"
    description             = ""
    direction               = "INGRESS"
    disabled                = false
    priority                = "1000"
    source_ranges           = ["10.149.0.0/16", "10.24.16.0/20", "10.193.0.0/16"]
    destination_ranges      = ["172.16.0.128/28"]  
    source_tags             = null
    source_service_accounts = null
    target_tags             = null
    target_service_accounts = null
