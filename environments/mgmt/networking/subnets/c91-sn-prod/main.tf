module sn-c91-prod-ass1{
    ...
    secondary_ranges = {
        "sn-c91-prod-ass1-apps-01" = [
            {
                range_name    = "sn-c91-prod-ass1-apps-gpod1"
                ip_cidr_range = var.app_sc_subnet_cidr_pod
            },
            {
                range_name    = "sn-c91-prod-ass1-apps-gsvc1"
